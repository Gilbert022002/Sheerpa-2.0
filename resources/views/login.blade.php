    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-card-light rounded-3xl p-8 md:p-10 soft-shadow border border-border-light">
            <div class="text-center mb-8">
                <h1 class="text-2xl font-black mb-2">Bon retour parmi nous</h1>
                <p class="text-text-sub-light text-sm font-medium">Veuillez entrer vos informations pour vous connecter</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-6">
                ...
                <div class="space-y-2">
                    <div class="flex justify-between items-center px-1">
                        <label class="text-sm font-bold" for="password">Mot de passe</label>
                        <a href="#" class="text-xs font-bold text-primary hover:text-secondary transition-colors">Mot de passe oublié ?</a>
                    </div>
                    <div class="flex items-center rounded-xl bg-background-light border border-transparent focus-within:border-primary/30 transition-all overflow-hidden">
                        <div class="pl-4 text-text-sub-light flex items-center">
                ...
                <div class="flex items-center gap-3 px-1">
                    ...
                    >
                    <label for="remember" class="text-sm font-medium text-text-sub-light cursor-pointer select-none">Se souvenir de moi</label>
                </div>
            ...
            <div class="mt-8 pt-8 border-t border-border-light text-center">
                <p class="text-sm text-text-sub-light font-medium">
                    ...
                    <a href="{{ route('register') }}" class="text-secondary font-bold hover:underline ml-1">Créer un compte</a>
                </p>
            </div>
        </div>
